...
EntryPoint functionPtrs[] = {&write, &read, &accessClock, &memoryAlloc, &memoryFree, &memoryInfo, &newProcess, &exit, &_hlt, &blockProcessPID, &yield, &sem_create, &sem_wait, &sem_post, &sem_close, &sem_info};
